...
public class ProductionTechnology {
	...
	public enum ProductionFunctionDefinition {

		/**
		 * The Leontief production function is based on the formular<br>
		...
		/**
		 * The Cobb-Douglas production function is based on the formular<br>
		...
		/**
		 * The perfect substitution production function is based on the formular<br>
		 * <i>output=input[0]*alpha[0]+...+input[n]*alpha[n]</i><br>
		...
		private ProductionFunctionDefinition(String name, IProductionFunction pf) {
			this.name=name;
			pfd=pf;
		}
	...
	public final static class JDOProductionFunctionTypeConverter
			implements AttributeConverter<ProductionFunctionDefinition, String> {

		@Override
		public String convertToDatastore(ProductionFunctionDefinition pfd) {
			return pfd.toString();
		}

		@Override
		public ProductionFunctionDefinition convertToAttribute(String name) {
			for (final ProductionFunctionDefinition element : ProductionFunctionDefinition.values())
	...
	private Good machine=null; // which machine is used for this techology?
	private int defaultCapacity; // output capacity of good PER UNIT of this good's machine
	private int defaultWorkers; // number of workers who can use the machine IN PARALLEL
	...
	@Convert(org.simnation.model.technology.ProductionTechnology.JDOProductionFunctionTypeConverter.class)
	private ProductionFunctionDefinition productionFunctionDefinition;
	...
	public ProductionFunctionDefinition getProductionFunction() {
		return productionFunctionDefinition;
	}

	public void setProductionFunction(ProductionFunctionDefinition value) {
		productionFunctionDefinition=value;
	}
	...
	public void setDefaultWorkers(int value) {
		defaultWorkers=value;
	}
