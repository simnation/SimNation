...
public abstract class AbstractBasicAgent<S extends State, E extends Enum<E>> extends RoutingAgent<S, E> {
	...
	/** static logger to be used by all agents */
	...
	protected static class UnhandledEventType extends RuntimeException {
		public UnhandledEventType(String eventName, String agentName) {
			super("Event "+eventName+" could not be handled by "+agentName);
		}
	}
	...
	protected static class UnhandledMessageType extends RuntimeException {
		public UnhandledMessageType(String typeName, String agentName) {
			super("Message content of type "+typeName+" could not be handled by "+agentName);
		}
	}
