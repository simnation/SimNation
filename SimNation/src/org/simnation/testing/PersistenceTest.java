...
import org.simnation.model.technology.IProductionFunction;
import org.simnation.model.technology.Precursor;
import org.simnation.model.technology.ProductionTechnology;
import org.simnation.model.technology.Good.GOOD_TYPE;
import org.simnation.model.technology.Good.RESOURCE_TYPE;
import org.simnation.model.technology.ProductionTechnology.ProductionFunctionDefinition;
...
public final class PersistenceTest {
	...
	private void addGood(String name) {
		...
		good.setResourceType(RESOURCE_TYPE.AGRICULTURE);
		good.setUnit("pc.");
		goodSet.add(good);
	...
	public static void main(String[] args) {
		...
		technology.setProductionFunction(ProductionFunctionDefinition.COBB_DOUGLAS);
		test.getGood("Grain").setProductionTechnology(technology);
		technology.setProductionFunction(ProductionFunctionDefinition.PERFECT_SUBSTITUTION);
