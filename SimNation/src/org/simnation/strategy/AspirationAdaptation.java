...
public class AspirationAdaptation {
	...
	public interface GoalVariable {
		...
		float getLimit(); // limit for aspiration adaptation scheme
	...
	/**
	 * Sets the aspiration level according to the current value of the goal
	 * variables.
	 * <p>
	 * Note: Rounding off should put the aspiration level automatically within the
	 ...
	 * <p>
	 * Tries to maximize the aspiration level (AL) of the most urgent goal variable.
	 * Then the AL of the second most urgent is maximized and so on. Result should
	 ...
	 * <p>
	 * The new urgency order contains the indexes of the goal variable sorted with
